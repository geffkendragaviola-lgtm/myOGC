...
return [
    ...
    'auth_profiles' => [
        ...
        'oauth' => [
             ...
             */
            'credentials_json' => env('GOOGLE_CALENDAR_OAUTH_CREDENTIALS', storage_path('app/google-calendar/oauth-credentials.json')),

            /*
             * Path to the json file containing the oauth2 token.
             */
            'token_json' => env('GOOGLE_CALENDAR_OAUTH_TOKEN', storage_path('app/google-calendar/oauth-token.json')),
        ],
    ],
