...
<style>
    ...
    .edit-faq-glow.one { top: -30px; left: -40px; width: 200px; height: 200px; background: var(--gold-400); }
    .edit-faq-glow.two { bottom: -30px; right: -60px; width: 220px; height: 220px; background: var(--maroon-800); }
...
<div class="min-h-screen edit-faq-shell">
                ...
                <div class="hero-card">
                    <div class="relative p-4 sm:p-5 flex items-start gap-3">
                        ...
                        <div class="min-w-0">
                            ...
                            <h1 class="text-lg sm:text-xl lg:text-2xl font-semibold tracking-tight text-[#2c2420] mt-2">Edit FAQ</h1>
        ...
        <div class="panel-card">
            ...
            <div class="panel-header">
                ...
                <div>
                    ...
                    <p class="panel-subtitle hidden sm:block">Update the question, answer, category, order, and active status.</p>
                </div>
            </div>
                ...
                <form action="{{ route('admin.faqs.update', $faq) }}" method="POST">
                    ...
                    <div class="section-card mb-4">
                        ...
                        <div class="section-header">
                            ...
                            <div>
                                ...
                                <p class="section-subtitle hidden sm:block">Edit the content and display settings for this FAQ entry.</p>
                            </div>
                        </div>
                        ...
                        <div class="p-3 sm:p-4 grid grid-cols-1 gap-3 sm:gap-4">
                            <div>
                                ...
                                <textarea name="question" id="question" rows="3" required
                                          class="textarea-field">{{ old('question', $faq->question) }}</textarea>
                                @error('question')
                            ...
                            <div>
                                ...
                                <textarea name="answer" id="answer" rows="5" required
                                          class="textarea-field">{{ old('answer', $faq->answer) }}</textarea>
                                @error('answer')
                                    <p class="error-text">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                                <div>
                                    ...
                                    <input type="text" name="category" id="category" value="{{ old('category', $faq->category) }}"
                                           class="input-field" placeholder="e.g., General, Counseling">
                                    @error('category')
                                        <p class="error-text">{{ $message }}</p>
                                    @enderror
                                </div>
                    ...
                    <div class="mt-4 flex flex-col sm:flex-row justify-end gap-2 sm:gap-3">
                        ...
                        <button type="submit" class="primary-btn rounded-lg">
                            <i class="fas fa-save mr-1.5 text-[9px] sm:text-xs"></i> Update FAQ
                        </button>
                    </div>
                </form>
            </div>
