                ...
                <div class="summary-card min-w-[240px] sm:min-w-[280px]">
                    <div class="relative h-full flex flex-col justify-center p-4 sm:p-5">
                        <div class="flex items-center gap-3 sm:gap-4">
                            ...
                            <div class="min-w-0">
                                <div class="summary-label">Student Profile</div>
                                <div class="summary-value truncate" title="{{ $student->user->first_name }} {{ $student->user->last_name }}">{{ $student->user->first_name }} {{ $student->user->last_name }}</div>
