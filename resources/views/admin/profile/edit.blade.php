...
<div class="min-h-screen profile-shell">
    ...
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 py-5 md:py-8">
                    ...
                    <div class="relative p-4 sm:p-5 flex items-start gap-3">
                        ...
                        <div class="min-w-0">
                            ...
                            <p class="text-[#6b5e57] text-xs sm:text-sm mt-1.5 max-w-2xl">
                                Manage your profile photo, email address, and account password.
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="relative h-full flex flex-col sm:flex-row items-center justify-between gap-3 p-4">
                        <div class="flex items-center gap-3 text-center sm:text-left">
                            ...
                            <div class="min-w-0">
                                ...
                                <p class="summary-subtext hidden sm:block">Return to your admin dashboard.</p>
                            </div>
                        </div>
        ...
        @if(session('status') === 'admin-profile-updated')
            <div class="mb-4 bg-[#ecfdf5] text-[#059669] border border-[#10b981]/30 p-3 rounded-lg flex items-center gap-2 text-sm font-semibold shadow-sm">
                <i class="fas fa-check-circle"></i> Email address updated successfully.
            </div>
        @endif
            ...
            <div class="panel-card flex flex-col">
                ...
                <div class="panel-header">
                    ...
                    <div>
                        ...
                        <p class="panel-subtitle hidden sm:block">Update your photo and contact details.</p>
                    </div>
                </div>
                ...
                <div class="p-3 sm:p-4 flex-1 flex flex-col">
                    <div class="section-card mb-4">
                        ...
                        <div class="section-header">
                            ...
                            <div>
                                ...
                                <p class="section-subtitle hidden sm:block">JPG, PNG or GIF. Max 4MB.</p>
                            </div>
                        </div>
                        <div class="p-3 sm:p-4">
                            <form method="POST" action="{{ route('profile.admin.picture') }}" enctype="multipart/form-data">
                                @csrf
                                        ...
                                        <div class="w-20 h-20 sm:w-24 sm:h-24 rounded-full overflow-hidden border-2 border-[rgba(212,175,55,0.4)] shadow-sm bg-[#faf8f5]">
                                            ...
                                            @else
                                                <div class="w-full h-full flex items-center justify-center bg-gradient-to-br from-[#7a2a2a] to-[#3a0c0c]" id="pfp-placeholder">
                                                    <i class="fas fa-user-shield text-[#fef9e7] text-2xl sm:text-3xl"></i>
                                                </div>
                    ...
                    <div class="section-card flex-1 flex flex-col">
                        <div class="section-topline"></div>
                        <div class="section-header">
                            <div class="section-icon"><i class="fas fa-envelope text-[9px] sm:text-xs"></i></div>
                            <div>
                                <h3 class="section-title">Email Address</h3>
                                <p class="section-subtitle hidden sm:block">Update your login email address.</p>
                            </div>
                        </div>
                        <div class="p-3 sm:p-4 flex-1 flex flex-col">
                            <form method="POST" action="{{ route('profile.admin.update') }}" class="flex-1 flex flex-col">
                                @csrf
                                @method('patch')
                                <div class="mb-4">
                                    <label for="admin_email" class="field-label">Email Address *</label>
                                    <input type="email" id="admin_email" name="email" value="{{ old('email', Auth::user()->email) }}" required
                                           class="input-field">
                                ...
                                <div class="mt-auto flex justify-end">
                                    <button type="submit" class="primary-btn rounded-lg">
                                        <i class="fas fa-save mr-1.5 text-[9px] sm:text-xs"></i> Save Email
                                    </button>
                                </div>
                            </form>
                        </div>
                        ...
                        <div class="p-3 sm:p-4 flex-1 flex flex-col">
                            <form method="POST" action="{{ route('profile.password.update') }}" class="flex-1 flex flex-col">
                                ...
                                <div class="grid grid-cols-1 gap-3 sm:gap-4">
                                    <div>
                                        <label for="admin_current_password" class="field-label">Current Password *</label>
                                    ...
                                    <div>
                                        <label for="admin_new_password" class="field-label">New Password *</label>
                                        <input type="password" id="admin_new_password" name="password" required
                                               class="input-field">
                                        @error('password') <p class="error-text">{{ $message }}</p> @enderror
                                    </div>
                                    
                                    <div>
                                        <label for="admin_password_confirmation" class="field-label">Confirm New Password *</label>
