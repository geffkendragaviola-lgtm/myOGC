        ...
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 py-5 md:py-8">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-[1fr_auto] gap-4 items-stretch">
                        ...
                        <div class="relative flex items-start gap-3 p-4 sm:p-5">
                            ...
                            <div class="min-w-0">
                                ...
                                <p class="text-[#6b5e57] text-xs sm:text-sm mt-1.5 max-w-2xl">
                                    Feedback submissions and satisfaction overview.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="summary-card">
                        <div class="relative h-full flex flex-col sm:flex-row items-center justify-between gap-3 p-4">
                            ...
                            <a href="{{ route('admin.feedback.export', request()->query()) }}" class="inline-flex items-center justify-center px-4 py-2 sm:py-2.5 rounded-lg bg-white/10 hover:bg-white/20 text-white font-medium transition-all text-xs sm:text-sm border border-white/20 backdrop-blur-sm shadow-sm">
            ...
            <div class="relative overflow-hidden rounded-xl border border-[#e5e0db]/80 bg-white/95 backdrop-blur-sm shadow-sm mb-5 sm:mb-6">
                ...
                <div class="p-3 sm:p-4">
                    <form method="GET" action="{{ route('admin.feedback.index') }}" class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-6 gap-3 sm:gap-4">
                        <div>
                        ...
                        <div class="flex items-end gap-2 sm:gap-3">
                            ...
                            <a href="{{ route('admin.feedback.index') }}" class="inline-flex items-center justify-center px-3 sm:px-4 py-2 sm:py-2.5 rounded-lg bg-[#f5f0eb] text-[#6b5e57] hover:bg-[#e5e0db] transition font-medium text-xs sm:text-sm">
                                ...
                                <tr class="group hover:bg-[#fdf9f6] transition-colors duration-150">
                                    ...
                                    <td class="px-4 sm:px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center gap-2.5">
                                            <a href="{{ route('admin.feedback.show', $feedback) }}" class="inline-flex items-center justify-center w-7 h-7 rounded-md bg-[#fdf2f2] text-[#7a2a2a] hover:bg-[#7a2a2a] hover:text-white transition-colors" title="View Details">
