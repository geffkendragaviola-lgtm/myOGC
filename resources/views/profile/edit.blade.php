                    ...
                    <div class="relative p-4 sm:p-5 flex items-start gap-3">
                        ...
                        <div class="min-w-0">
                            ...
                            <p class="text-[#6b5e57] text-xs sm:text-sm mt-1.5 max-w-2xl">
                                Manage your profile photo, view your account email, and update your password.
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="relative h-full flex flex-col sm:flex-row items-center justify-between gap-3 p-4">
                        <div class="flex items-center gap-3 text-center sm:text-left">
                            ...
                            <div class="min-w-0">
                                ...
                                <p class="summary-subtext hidden sm:block">Return to your student dashboard.</p>
                            </div>
                        </div>
            ...
            <div class="panel-card flex flex-col">
                ...
                <div class="panel-header">
                    ...
                    <div>
                        ...
                        <p class="panel-subtitle hidden sm:block">Update your photo and view your email details.</p>
                    </div>
                </div>
                                    ...
                                    <div class="relative flex-shrink-0">
                                        <div class="w-20 h-20 sm:w-24 sm:h-24 rounded-full overflow-hidden border-2 border-[rgba(212,175,55,0.4)] shadow-sm bg-[#faf8f5]">
                                            @if($studentProfile?->profile_picture)
                                                <img src="{{ asset('storage/' . $studentProfile->profile_picture) }}"
                                                     alt="Profile Picture"
                                            ...
                                            @else
                                                <div class="w-full h-full flex items-center justify-center bg-gradient-to-br from-[#7a2a2a] to-[#3a0c0c]" id="pfp-placeholder">
                                                    <span class="text-[#fef9e7] text-2xl sm:text-3xl font-bold uppercase">{{ substr(Auth::user()->first_name, 0, 1) }}</span>
                                                </div>
                    ...
                    <div class="section-card flex-1 flex flex-col">
                        ...
                        <div class="section-header">
                            ...
                            <div>
                                ...
                                <p class="section-subtitle hidden sm:block">Your primary account email address.</p>
                            </div>
                        </div>
                        <div class="p-3 sm:p-4 flex-1 flex flex-col">
                            <div class="mb-4">
            ...
            <div class="panel-card flex flex-col">
                ...
                <div class="panel-header">
                    ...
                    <div>
                        ...
                        <p class="panel-subtitle hidden sm:block">Ensure your account is using a secure password.</p>
                    </div>
                </div>
