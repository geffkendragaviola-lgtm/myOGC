            ...
            <div class="ogc-profile-dropdown">
                ...
                <div class="ogc-profile-menu hidden" id="profile-dropdown-menu">
                    ...
                    <a href="{{ route('profile.edit') }}">
                        <i class="fas fa-circle-user mr-3 text-[var(--maroon-soft)]"></i> My Profile
                    </a>
        ...
        <div class="sidebar-user-section">
            <div class="sidebar-user-card">
                ...
                <span class="sidebar-role-pill">
                    <i class="fas fa-user-doctor text-[10px]"></i> Counselor
                </span>
            </div>
        </div>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    if (notifBtn && notifPanel) {
        ...
        // Mark all as read — dim items, don't remove them
        if (markAllBtn) {
    ...
    if (sidebarToggleBtn) {
        const MOBILE_BP  = 640;
        const TABLET_BP  = 900;
        const COUNSEL_KEY = 'ogcSidebarCollapsed';
        ...
        if (!isMobile() && !isTablet()) {
            if (localStorage.getItem(COUNSEL_KEY) === 'true') {
        ...
        sidebarToggleBtn.addEventListener('click', function () {
            if (isMobile()) {
                ...
                localStorage.setItem(COUNSEL_KEY, isCollapsed ? 'true' : 'false');
            }
        });
