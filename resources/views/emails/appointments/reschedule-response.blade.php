<!DOCTYPE html>
<html>
<head><meta charset="utf-8"><title>Reschedule Response</title></head>
<body style="font-family: Arial, sans-serif; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
    ...
    <div style="background: {{ $color }}; padding: 20px; border-radius: 8px 8px 0 0;">
        <h2 style="color: #fff; margin: 0;">Reschedule Request {{ $label }}</h2>
    </div>
    <div style="border: 1px solid #e5e7eb; border-top: none; padding: 24px; border-radius: 0 0 8px 8px;">
        ...
        <p>
            ...
            has <strong>{{ strtolower($label) }}</strong> your reschedule request.
        </p>
