...
<div class="container mx-auto px-6 py-8">
    <div class="bg-white rounded-xl shadow-sm p-6 mb-6">
        <div class="flex flex-col md:flex-row md:items-center md:justify-between">
            <div>
                <h1 class="text-3xl font-bold text-gray-800">Availability &amp; Booking Limits</h1>
                <p class="text-gray-600 mt-2">Set your weekly availability, daily limits, and date overrides.</p>
            </div>
