...
<body class="bg-gray-50">
                                ...
                                <tr class="hover:bg-gray-50 transition fade-in">
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="text-sm text-gray-900 max-w-xs">
                                            {{ Str::limit($appointment->concern, 100) }}
                                        </div>
                                        @if($appointment->notes)
                                            <div class="text-xs text-gray-500 mt-1">
                                                <i class="fas fa-sticky-note mr-1"></i>Has counselor notes
                                            </div>
                                        @endif
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
        ...
        <div class="bg-white rounded-xl shadow-2xl max-w-md w-full mx-4">
            ...
            <div class="p-6">
                ...
                <div class="space-y-3">
                    ...
                    <button onclick="showTransferOptions()"
                        ...
                        <div class="flex items-center">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-blue-600">Student can choose from available counselors</p>
                            </div>
                        </div>
                    </button>
                </div>
    ...
    <div id="transferModal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center hidden z-50">
        <div class="bg-white rounded-xl shadow-2xl max-w-2xl w-full mx-4 max-h-[90vh] overflow-y-auto">
            ...
            <div class="p-6">
                <p class="text-gray-600 mb-4">This appointment will be cancelled and the student will be prompted to book with another counselor.</p>

                <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-4">
                    <div class="flex items-center">
                        <i class="fas fa-info-circle text-yellow-600 mr-2"></i>
                        <p class="text-yellow-800 text-sm">
                            The student will receive a notification to book with another available counselor.
                        </p>
                    </div>
                </div>
                ...
                <form id="transferForm" method="POST">
                    ...
                    @method('PATCH')
                    <input type="hidden" name="status" value="rejected">
                    <input type="hidden" name="transfer_to_counselor" value="true">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="notes"
                                  id="transferReason"
                                  rows="3"
                                  placeholder="Briefly explain why you're transferring this appointment..."
                                  class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition"></textarea>
                    </div>
    ...
    <script>
        ...
        function showRejectionOptions(appointmentId) {
            ...
            transferForm.action = `/counselor/appointments/${appointmentId}/update-status`;
