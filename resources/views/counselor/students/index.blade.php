        ...
        <div class="mb-6 sm:mb-8">
            <div class="grid grid-cols-1 xl:grid-cols-[1fr_auto] gap-4 items-stretch">
                    ...
                    <div class="relative flex items-start gap-3 p-4 sm:p-5">
                        ...
                        <div class="min-w-0">
                            ...
                            <p class="text-[#6b5e57] text-xs sm:text-sm mt-1.5 max-w-2xl">
                                All students in your assigned college(s).
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="summary-card">
                    ...
                    <div class="relative h-full flex flex-col sm:flex-row items-center justify-between gap-3 p-4 sm:px-6">
                        <div class="flex items-center gap-3 text-center sm:text-left">
                            <div class="summary-icon flex-shrink-0">
                                <i class="fas fa-users text-sm"></i>
                            </div>
                            <div class="min-w-0">
                                <p class="summary-label">Total Assigned</p>
                                <p class="summary-value">{{ $students->total() }}</p>
                                <p class="summary-subtext hidden sm:block">Live student caseload count</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="panel-card overflow-hidden">
            <div class="table-header-bar">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <h2 class="text-sm font-medium text-[#2c2420]">Student Caseload</h2>
                ...
                <table class="min-w-[850px] md:min-w-full divide-y divide-[#e5e0db]/60 w-full">
                    <thead class="bg-[#faf8f5]/85">
                        <tr>
                            ...
                            <th class="px-3 sm:px-4 py-2.5 sm:py-3 text-left text-[10px] sm:text-[11px] font-semibold text-[#8b7e76] uppercase tracking-[0.14em] whitespace-nowrap">College</th>
                    ...
                    <tbody class="bg-white divide-y divide-[#e5e0db]/50">
                        @forelse($students as $student)
                            ...
                            @endphp
                            <tr class="table-row group cursor-pointer {{ $isHighRisk ? 'high-risk-row' : '' }}" onclick="window.location='{{ route('counselor.students.profile', $student) }}'">
                                ...
                                <td class="px-3 sm:px-4 py-2.5 sm:py-3">
                                    <div class="flex items-center gap-2.5">
                                        <div class="avatar-badge overflow-hidden {{ $isHighRisk ? 'ring-2 ring-red-400' : '' }}" style="{{ $student->profile_picture ? 'background:none;padding:0;' : '' }}">
                                ...
                                <td class="px-3 sm:px-4 py-2.5 sm:py-3">
                                    <div class="text-xs sm:text-sm font-semibold text-[#2c2420] truncate max-w-[180px]">{{ $student->college->name ?? 'N/A' }}</div>
                                </td>
                                ...
                                <td class="px-3 sm:px-4 py-2.5 sm:py-3">
                                    ...
                                    <div class="text-[10px] sm:text-[11px] text-[#8b7e76] mt-0.5 inline-flex items-center">
                                        <i class="fas fa-calendar-days text-[#c4b8b1] text-[9px] sm:text-[10px] mr-1.5"></i>
                                ...
                                <td class="px-3 sm:px-4 py-2.5 sm:py-3 whitespace-nowrap">
                                    <div class="flex flex-col gap-1.5 items-start">
                                        @if($isHighRisk)
                                            ...
                                            <span class="inline-flex items-center px-2 py-0.5 sm:px-2.5 sm:py-1 text-[10px] sm:text-xs font-semibold rounded-full bg-[#fef2f2] text-[#b91c1c] border border-[#ef4444]/30">
                                                <i class="fas fa-flag mr-1 text-[9px] sm:text-[10px]"></i> Flagged by Counselor
                                            </span>
                                            @endif
                                        @endif
                        ...
                        @empty
                            <tr>
                                <td colspan="7" class="px-4 py-8 sm:py-10 text-center">
...
<style>
    ...
    .high-risk-row { background: rgba(254,242,242,0.5); }
    .high-risk-row:hover { background: rgba(254,226,226,0.6); }
