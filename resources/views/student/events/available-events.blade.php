        ...
        <div class="bg-white rounded-xl shadow-sm p-6 mb-6">
            <div class="flex flex-col md:flex-row md:items-center md:justify-between">
                <div>
                    ...
                    <p class="text-gray-600 mt-2">Browse all upcoming mental health events and workshops</p>
                </div>
                <div class="mt-4 md:mt-0">
                    <a href="{{ route('mhc') }}"
                       class="bg-gray-100 text-[#820000] px-6 py-3 rounded-lg hover:bg-gray-200 transition font-semibold inline-flex items-center shadow-sm">
