...
class CounselorController extends Controller
{
    public function dashboard()
    {
        ...
        // Get appointments from ALL assigned colleges
        $counselorIds = $counselorAssignments->pluck('id');

        // Today's appointments from all assigned colleges
        ...
        // Upcoming appointments from all assigned colleges
        ...
        // Appointment statistics from all assigned colleges
        $appointmentStats = [
            'pending' => Appointment::whereIn('counselor_id', $counselorIds)
                ->where('status', 'pending')
                ->count(),
            'approved' => Appointment::whereIn('counselor_id', $counselorIds)
                ->where('status', 'approved')
                ->count(),
            'total' => Appointment::whereIn('counselor_id', $counselorIds)
    ...
    public function calendar(Request $request)
    {
        ...
        // Get ALL appointments for the selected date from ALL assigned colleges
        $appointments = Appointment::with('student.user', 'student.college')
            ->whereIn('counselor_id', $counselorIds)
            ->where('appointment_date', $date->toDateString())
            ->orderBy('start_time')
            ->get();

        // Format the start_time to match the slot format (H:i)
    ...
    public function appointments(Request $request)
    {
        ...
        // Add session notes data to each appointment
    ...
    public function updateAppointmentStatus(Request $request, Appointment $appointment)
    {
        ...
        // Check if the counselor owns this appointment (from any assigned college)
        $userId = Auth::id();
    ...
    public function getAppointmentDetails(Appointment $appointment)
    {
        ...
        $appointment->load(['student.user', 'student.college', 'sessionNotes']);
